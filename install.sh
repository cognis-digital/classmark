#!/usr/bin/env sh
# Universal installer for classmark. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/classmark.git"
echo "Installing classmark ..."
