...
Original library. **Public references**:
- ODNI CAPCO Implementation Manual (public)
- 32 CFR Part 2002 (CUI Program)
- ISOO NAS Marking Handbook

**No real classification content.** Operators on cleared systems supply real markings.
